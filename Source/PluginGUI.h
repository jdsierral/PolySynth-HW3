...
//				
//				g.setColour (slider.findColour (Slider::rotarySliderFillColourId).withAlpha (0.2f));
//				Path filledBase;
//				filledBase.addPieSegment (rx, ry, rw, rw, rotaryEndAngle, rotaryStartAngle + 2 * M_PI, 0.0);
//				g.fillPath (filledBase);
//			}
//		
//		{
//			const float lineThickness = 0;
//			Path outlineArc;
//			outlineArc.addPieSegment (rx, ry, rw, rw, rotaryStartAngle, rotaryEndAngle, 0.0);
//			g.strokePath (outlineArc, PathStrokeType (lineThickness));
//			
//			const float lineThickness2 = jmin (15.0f, jmin (width, height) * 0.45f) * 0.3f;
//			g.setColour (Colours::white);
//			Path baseLineArc;
//			baseLineArc.addPieSegment(rx, ry, rw, rw, rotaryEndAngle, rotaryStartAngle + 2 * M_PI, 0.0);
//			g.strokePath (baseLineArc, PathStrokeType (lineThickness2));
//			
//		}
//	}
};
